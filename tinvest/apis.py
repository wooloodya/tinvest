...
class SandboxApi(BaseApi):
    ...
    def sandbox_register_post(self, **kwargs):
        ...
        return self.client.request('POST', '/sandbox/register', response_model=Empty, **kwargs)

    def sandbox_currencies_balance_post(self, body: SandboxSetCurrencyBalanceRequest, **kwargs):
        """POST /sandbox/currencies/balance Выставление баланса по валютным позициям"""
        kwargs.setdefault('data', body.json(by_alias=True))
        return self.client.request('POST', '/sandbox/currencies/balance', response_model=Empty, **kwargs,)

    def sandbox_positions_balance_post(self, body: SandboxSetPositionBalanceRequest, **kwargs):
        """POST /sandbox/positions/balance Выставление баланса по инструментным позициям"""
        kwargs.setdefault('data', body.json(by_alias=True))
        return self.client.request('POST', '/sandbox/positions/balance', response_model=Empty, **kwargs,)

    def sandbox_clear_post(self, **kwargs):
        """POST /sandbox/clear Удаление всех позиций"""
        return self.client.request('POST', '/sandbox/clear', response_model=Empty, **kwargs)
...
class OrdersApi(BaseApi):
    ...
    def orders_get(self, **kwargs):
        ...
        return self.client.request('GET', '/orders', response_model=OrdersResponse, **kwargs)
    ...
    def orders_limit_order_post(self, figi: str, body: LimitOrderRequest, **kwargs):
        ...
        kwargs.setdefault('data', body.json(by_alias=True))
        return self.client.request('POST', '/orders/limit-order', response_model=LimitOrderResponse, **kwargs,)
    ...
    def orders_cancel_post(self, order_id: str, body: Optional[Empty] = None, **kwargs):
        ...
        if body:
            kwargs.setdefault('data', body.json(by_alias=True))
        return self.client.request('POST', '/orders/cancel', response_model=Empty, **kwargs)
...
class PortfolioApi(BaseApi):
    ...
    def portfolio_get(self, **kwargs):
        ...
        return self.client.request('GET', '/portfolio', response_model=PortfolioResponse, **kwargs)

    def portfolio_currencies_get(self, **kwargs):
        """GET /portfolio/currencies Получение валютных активов клиента"""
        return self.client.request(
            'GET', '/portfolio/currencies', response_model=PortfolioCurrenciesResponse, **kwargs,
        )
...
class MarketApi(BaseApi):
    ...
    def market_stocks_get(self, **kwargs):
        ...
        return self.client.request('GET', '/market/stocks', response_model=MarketInstrumentListResponse, **kwargs,)

    def market_bonds_get(self, **kwargs):
        """GET /market/bonds Получение списка облигаций"""
        return self.client.request('GET', '/market/bonds', response_model=MarketInstrumentListResponse, **kwargs,)

    def market_etfs_get(self, **kwargs):
        """GET /market/etfs Получение списка ETF"""
        return self.client.request('GET', '/market/etfs', response_model=MarketInstrumentListResponse, **kwargs,)

    def market_currencies_get(self, **kwargs):
        """GET /market/currencies Получение списка валютных пар"""
        return self.client.request('GET', '/market/currencies', response_model=MarketInstrumentListResponse, **kwargs,)
    ...
    def market_orderbook_get(self, figi: str, depth: int, **kwargs):
        ...
        return self.client.request('GET', '/market/orderbook', response_model=OrderbookResponse, **kwargs,)
    ...
    def market_candles_get(
        ...
        return self.client.request('GET', '/market/candles', response_model=CandlesResponse, **kwargs)
    ...
    def market_search_by_figi_get(self, figi: str, **kwargs):
        ...
        params = kwargs['params']
        params.setdefault('figi', figi)
        return self.client.request('GET', '/market/search/by-figi', response_model=MarketInstrumentResponse, **kwargs,)
...
class OperationsApi(BaseApi):
    ...
    def operations_get(self, from_: str, to: str, figi: Optional[str] = None, **kwargs):
        ...
        if figi:
            params.setdefault('figi', figi)
        return self.client.request('GET', '/operations', response_model=OperationsResponse, **kwargs)
